...
if df_total is not None:
    ...
    with tab3:
        ...
        legislação = [
            ...
            ["Portaria MGI nº 2.897/2024", "Fixa o valor da Assistência Pré-Escolar (R$ 484,90).", "https://www.in.gov.br/en/web/dou/-/portaria-mgi-n-2.897-de-30-de-abril-de-2024-557088279"],
